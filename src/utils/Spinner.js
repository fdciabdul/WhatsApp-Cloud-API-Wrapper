...
const { dashes, dots } = require('./spinners/frame.json');

const { purgeSpinnerOptions, purgeSpinnersOptions, colorOptions, breakText, getLinesLength, terminalSupportsUnicode } = require('./SpinHelper');
const { isValidStatus, writeStream, cleanStream } = require('./SpinHelper');
